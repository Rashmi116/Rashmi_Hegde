...
/**
 * Servlet implementation class ServletUsingHttpSess
 */
public class ServletUsingHttpSess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletUsingHttpSess() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<HTML>");
		 ...
		 out.println("Enter item and quantity you want to purchase");
		 //create a HTML Form
		 String url = "/SessionManagement1/session";
