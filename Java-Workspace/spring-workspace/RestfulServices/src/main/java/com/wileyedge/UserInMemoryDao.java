...
public class UserInMemoryDao implements IDao {
	...
	static {
		...
		userCount=3;
		users.add(new User(1,"Rashmi",new Date()));
		users.add(new User(2,"Lavanya",new Date()));
		users.add(new User(3,"Raksha",new Date()));
	}
	...
	public Optional<User> findById(int id) {
		System.out.println("Inside findById() method UserInMemoryDao");
